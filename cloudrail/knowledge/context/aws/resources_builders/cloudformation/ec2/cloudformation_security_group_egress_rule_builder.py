...
class CloudformationSecurityGroupEgressRuleBuilder(CloudformationSecurityGroupRuleBaseBuilder):

    def __init__(self, cfn_by_type_map: Dict[CloudformationResourceType, Dict[str, Dict]]):
        super().__init__(CloudformationResourceType.SECURITY_GROUP_EGRESS, cfn_by_type_map)
