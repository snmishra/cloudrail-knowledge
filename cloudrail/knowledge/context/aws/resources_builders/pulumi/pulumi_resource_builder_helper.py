...
from cloudrail.knowledge.context.aws.resources.apigateway.rest_api_gw import (
    ApiGatewayType,
    RestApiGw,
)
from cloudrail.knowledge.context.aws.resources.apigateway.rest_api_gw_domain import (
    RestApiGwDomain,
)
from cloudrail.knowledge.context.aws.resources.apigateway.rest_api_gw_mapping import (
    RestApiGwMapping,
)
from cloudrail.knowledge.context.aws.resources.apigateway.rest_api_gw_policy import (
    RestApiGwPolicy,
)
from cloudrail.knowledge.context.aws.resources.apigatewayv2.api_gateway_v2 import (
    ApiGateway,
)
from cloudrail.knowledge.context.aws.resources.apigatewayv2.api_gateway_v2_integration import (
    ApiGatewayV2Integration,
)
from cloudrail.knowledge.context.aws.resources.apigatewayv2.api_gateway_v2_vpc_link import (
    ApiGatewayVpcLink,
)
from cloudrail.knowledge.context.aws.resources.athena.athena_database import (
    AthenaDatabase,
)
from cloudrail.knowledge.context.aws.resources.athena.athena_workgroup import (
    AthenaWorkgroup,
)
from cloudrail.knowledge.context.aws.resources.autoscaling.launch_configuration import (
    AutoScalingGroup,
    LaunchConfiguration,
)
from cloudrail.knowledge.context.aws.resources.autoscaling.launch_template import (
    LaunchTemplate,
)
...
from cloudrail.knowledge.context.aws.resources.cloudfront.cloudfront_distribution_logging import (
    CloudfrontDistributionLogging,
)
from cloudrail.knowledge.context.aws.resources.cloudfront.origin_access_identity import (
    OriginAccessIdentity,
)
from cloudrail.knowledge.context.aws.resources.cloudhsmv2.cloudhsm_v2_cluster import (
    CloudHsmV2Cluster,
)
from cloudrail.knowledge.context.aws.resources.cloudhsmv2.cloudhsm_v2_hsm import (
    CloudHsmV2Hsm,
)
...
from cloudrail.knowledge.context.aws.resources.cloudwatch.cloud_watch_log_group import (
    CloudWatchLogGroup,
)
from cloudrail.knowledge.context.aws.resources.cloudwatch.cloudwatch_logs_destination import (
    CloudWatchLogsDestination,
)
from cloudrail.knowledge.context.aws.resources.cloudwatch.cloudwatch_logs_destination_policy import (
    CloudWatchLogsDestinationPolicy,
)
from cloudrail.knowledge.context.aws.resources.codebuild.codebuild_project import (
    CodeBuildProject,
)
from cloudrail.knowledge.context.aws.resources.codebuild.codebuild_report_group import (
    CodeBuildReportGroup,
)
from cloudrail.knowledge.context.aws.resources.configservice.config_aggregator import (
    ConfigAggregator,
)
from cloudrail.knowledge.context.aws.resources.dax.dax_cluster import DaxCluster
from cloudrail.knowledge.context.aws.resources.dms.dms_replication_instance import (
    DmsReplicationInstance,
)
from cloudrail.knowledge.context.aws.resources.dms.dms_replication_instance_subnet_group import (
    DmsReplicationInstanceSubnetGroup,
)
from cloudrail.knowledge.context.aws.resources.docdb.docdb_cluster import (
    DocumentDbCluster,
)
from cloudrail.knowledge.context.aws.resources.docdb.docdb_cluster_parameter import (
    DocDbClusterParameter,
)
from cloudrail.knowledge.context.aws.resources.docdb.docdb_cluster_parameter_group import (
    DocDbClusterParameterGroup,
)
from cloudrail.knowledge.context.aws.resources.ds.directory_service import (
    DirectoryService,
)
from cloudrail.knowledge.context.aws.resources.dynamodb.dynamodb_table import (
    BillingMode,
    DynamoDbTable,
    TableField,
    TableFieldType,
...
from cloudrail.knowledge.context.aws.resources.ec2.ec2_instance import (
    AssociatePublicIpAddress,
    Ec2Instance,
)
from cloudrail.knowledge.context.aws.resources.ec2.elastic_ip import ElasticIp
from cloudrail.knowledge.context.aws.resources.ec2.internet_gateway import (
    InternetGateway,
)
from cloudrail.knowledge.context.aws.resources.ec2.main_route_table_association import (
...
from cloudrail.knowledge.context.aws.resources.ec2.network_acl_rule import (
    NetworkAclRule,
    RuleAction,
    RuleType,
)
from cloudrail.knowledge.context.aws.resources.ec2.network_interface import (
    NetworkInterface,
)
from cloudrail.knowledge.context.aws.resources.ec2.peering_connection import (
    PeeringConnection,
    PeeringVpcInfo,
)
...
from cloudrail.knowledge.context.aws.resources.ec2.route_table_association import (
    RouteTableAssociation,
)
from cloudrail.knowledge.context.aws.resources.ec2.security_group import SecurityGroup
from cloudrail.knowledge.context.aws.resources.ec2.security_group_rule import (
    ConnectionType,
    SecurityGroupRule,
...
from cloudrail.knowledge.context.aws.resources.ec2.transit_gateway_resource_type import (
    TransitGatewayResourceType,
)
from cloudrail.knowledge.context.aws.resources.ec2.transit_gateway_route import (
    TransitGatewayRoute,
    TransitGatewayRouteState,
    TransitGatewayRouteType,
)
from cloudrail.knowledge.context.aws.resources.ec2.transit_gateway_route_table import (
    TransitGatewayRouteTable,
)
from cloudrail.knowledge.context.aws.resources.ec2.transit_gateway_route_table_association import (
    TransitGatewayRouteTableAssociation,
)
from cloudrail.knowledge.context.aws.resources.ec2.transit_gateway_route_table_propagation import (
    TransitGatewayRouteTablePropagation,
)
from cloudrail.knowledge.context.aws.resources.ec2.transit_gateway_vpc_attachment import (
    TransitGatewayVpcAttachment,
)
from cloudrail.knowledge.context.aws.resources.ec2.vpc import Vpc, VpcAttribute
from cloudrail.knowledge.context.aws.resources.ec2.vpc_endpoint import (
    VpcEndpoint,
    VpcEndpointGateway,
    VpcEndpointInterface,
)
from cloudrail.knowledge.context.aws.resources.ec2.vpc_endpoint_route_table_association import (
    VpcEndpointRouteTableAssociation,
)
from cloudrail.knowledge.context.aws.resources.ec2.vpc_gateway_attachment import (
    VpcGatewayAttachment,
)
from cloudrail.knowledge.context.aws.resources.ecr.ecr_repository import EcrRepository
from cloudrail.knowledge.context.aws.resources.ecr.ecr_repository_policy import (
    EcrRepositoryPolicy,
)
from cloudrail.knowledge.context.aws.resources.ecs.ecs_cluster import EcsCluster
from cloudrail.knowledge.context.aws.resources.ecs.ecs_constants import (
    LaunchType,
    NetworkMode,
)
...
from cloudrail.knowledge.context.aws.resources.ecs.load_balancing_configuration import (
    LoadBalancingConfiguration,
)
from cloudrail.knowledge.context.aws.resources.efs.efs_file_system import (
    ElasticFileSystem,
)
from cloudrail.knowledge.context.aws.resources.efs.efs_mount_target import (
    EfsMountTarget,
)
...
from cloudrail.knowledge.context.aws.resources.elasticache.elasticache_cluster import (
    ElastiCacheCluster,
)
from cloudrail.knowledge.context.aws.resources.elasticache.elasticache_replication_group import (
    ElastiCacheReplicationGroup,
)
from cloudrail.knowledge.context.aws.resources.elasticache.elasticache_subnet_group import (
    ElastiCacheSubnetGroup,
)
from cloudrail.knowledge.context.aws.resources.elb.load_balancer import (
    LoadBalancer,
    LoadBalancerSchemeType,
    LoadBalancerType,
)
from cloudrail.knowledge.context.aws.resources.elb.load_balancer_attributes import (
    LoadBalancerAccessLogs,
    LoadBalancerAttributes,
)
from cloudrail.knowledge.context.aws.resources.elb.load_balancer_listener import (
    LoadBalancerListener,
)
from cloudrail.knowledge.context.aws.resources.elb.load_balancer_target import (
    LoadBalancerTarget,
)
from cloudrail.knowledge.context.aws.resources.elb.load_balancer_target_group import (
    LoadBalancerTargetGroup,
)
from cloudrail.knowledge.context.aws.resources.elb.load_balancer_target_group_association import (
    LoadBalancerTargetGroupAssociation,
)
from cloudrail.knowledge.context.aws.resources.emr.emr_cluster import EmrCluster
from cloudrail.knowledge.context.aws.resources.es.elastic_search_domain import (
    ElasticSearchDomain,
    LogPublishingOptions,
)
from cloudrail.knowledge.context.aws.resources.es.elastic_search_domain_policy import (
    ElasticSearchDomainPolicy,
)
from cloudrail.knowledge.context.aws.resources.fsx.fsx_windows_file_system import (
    FsxWindowsFileSystem,
)
from cloudrail.knowledge.context.aws.resources.glacier.glacier_vault import GlacierVault
from cloudrail.knowledge.context.aws.resources.glacier.glacier_vault_policy import (
    GlacierVaultPolicy,
)
from cloudrail.knowledge.context.aws.resources.globalaccelerator.global_accelerator import (
    GlobalAccelerator,
)
from cloudrail.knowledge.context.aws.resources.globalaccelerator.global_accelerator_attributes import (
    GlobalAcceleratorAttribute,
)
from cloudrail.knowledge.context.aws.resources.globalaccelerator.global_accelerator_endpoint_group import (
    GlobalAcceleratorEndpointGroup,
)
from cloudrail.knowledge.context.aws.resources.globalaccelerator.global_accelerator_listener import (
    GlobalAcceleratorListener,
)
from cloudrail.knowledge.context.aws.resources.glue.glue_connection import (
    GlueConnection,
)
from cloudrail.knowledge.context.aws.resources.glue.glue_data_catalog_crawler import (
    GlueCrawler,
)
from cloudrail.knowledge.context.aws.resources.glue.glue_data_catalog_policy import (
    GlueDataCatalogPolicy,
)
from cloudrail.knowledge.context.aws.resources.glue.glue_data_catalog_table import (
    GlueDataCatalogTable,
)
from cloudrail.knowledge.context.aws.resources.iam.iam_group import IamGroup
from cloudrail.knowledge.context.aws.resources.iam.iam_group_membership import (
    IamGroupMembership,
)
from cloudrail.knowledge.context.aws.resources.iam.iam_instance_profile import (
    IamInstanceProfile,
)
from cloudrail.knowledge.context.aws.resources.iam.iam_password_policy import (
    IamPasswordPolicy,
)
...
from cloudrail.knowledge.context.aws.resources.iam.iam_user_group_membership import (
    IamUserGroupMembership,
)
from cloudrail.knowledge.context.aws.resources.iam.iam_users_login_profile import (
    IamUsersLoginProfile,
)
from cloudrail.knowledge.context.aws.resources.iam.policy import (
    AssumeRolePolicy,
    InlinePolicy,
    ManagedPolicy,
    Policy,
...
from cloudrail.knowledge.context.aws.resources.kinesis.kinesis_firehose_stream import (
    KinesisFirehoseStream,
)
from cloudrail.knowledge.context.aws.resources.kinesis.kinesis_stream import (
    KinesisStream,
)
...
from cloudrail.knowledge.context.aws.resources.neptune.neptune_cluster import (
    NeptuneCluster,
)
from cloudrail.knowledge.context.aws.resources.neptune.neptune_instance import (
    NeptuneInstance,
)
from cloudrail.knowledge.context.aws.resources.networking_config.network_configuration import (
...
from cloudrail.knowledge.context.aws.resources.rds.rds_global_cluster import (
    RdsGlobalCluster,
)
...
from cloudrail.knowledge.context.aws.resources.redshift.redshift_logging import (
    RedshiftLogging,
)
from cloudrail.knowledge.context.aws.resources.redshift.redshift_subnet_group import (
    RedshiftSubnetGroup,
)
from cloudrail.knowledge.context.aws.resources.s3.public_access_block_settings import (
...
from cloudrail.knowledge.context.aws.resources.s3.s3_bucket_access_point import (
    S3BucketAccessPoint,
    S3BucketAccessPointNetworkOrigin,
    S3BucketAccessPointNetworkOriginType,
)
from cloudrail.knowledge.context.aws.resources.s3.s3_bucket_encryption import (
    S3BucketEncryption,
)
from cloudrail.knowledge.context.aws.resources.s3.s3_bucket_logging import (
    S3BucketLogging,
)
...
from cloudrail.knowledge.context.aws.resources.sagemaker.sagemaker_endpoint_config import (
    SageMakerEndpointConfig,
)
from cloudrail.knowledge.context.aws.resources.sagemaker.sagemaker_notebook_instance import (
    SageMakerNotebookInstance,
)
from cloudrail.knowledge.context.aws.resources.secretsmanager.secrets_manager_secret import (
    SecretsManagerSecret,
)
from cloudrail.knowledge.context.aws.resources.secretsmanager.secrets_manager_secret_policy import (
...
from cloudrail.knowledge.context.aws.resources.sqs.sqs_queue_policy import (
    SqsQueuePolicy,
)
...
def build_ec2(attributes: dict) -> Ec2Instance:
    ...
    security_groups_ids = _get_known_value(
        attributes, "security_groups"
    ) or _get_known_value(attributes, "vpc_security_group_ids")
    if primary_network_interface_id:
        network_interface_ids.append(primary_network_interface_id)
    associate_public_ip_address = (
        AssociatePublicIpAddress.convert_from_optional_boolean(
            _get_known_value(attributes, "associate_public_ip_address")
        )
    )
    ...
    return Ec2Instance(
        ...
        subnet_id=_get_known_value(attributes, "subnet_id"),
...
def build_user_login_profile(attributes: dict) -> IamUsersLoginProfile:
    return IamUsersLoginProfile(attributes["user"], attributes["account_id"])
...
def build_load_balancer_target_group_association(
    attributes: dict,
) -> LoadBalancerTargetGroupAssociation:
    ...
    return LoadBalancerTargetGroupAssociation(
        target_group_arns, load_balancer_arn, port, account, region
    )
...
def build_default_network_acl(attributes: dict) -> NetworkAcl:
    vpc_id = (
        attributes["vpc_id"]
        if _is_known_value(attributes, "vpc_id")
        else attributes["default_network_acl_id"].replace(
            ".default_network_acl_id", ".id"
        )
    )
    return NetworkAcl(
        network_acl_id=attributes["default_network_acl_id"],
        vpc_id=vpc_id,
        is_default=True,
        name=_get_name(attributes),
        subnet_ids=_get_known_value(attributes, "subnet_ids", []),
...
def build_default_route_table(attributes: dict) -> RouteTable:
    vpc_id = (
        attributes["vpc_id"]
        if _is_known_value(attributes, "vpc_id")
        else attributes["default_route_table_id"]
        .replace(".default_route_table_id", ".id")
        .replace(".main_route_table_id", ".id")
    )
    return RouteTable(
        route_table_id=attributes["default_route_table_id"],
        vpc_id=vpc_id,
        name=_get_name(attributes),
        region=attributes["region"],
        account=attributes["account_id"],
...
def build_inline_routes(
    raw_routes: dict, route_table_id: str, region: str, account: str
) -> List[Route]:
    routes = []
...
def build_route(attributes: dict) -> Route:
    route_table_id = attributes["route_table_id"]
    cidr = (
        _get_known_value(attributes, "destination_cidr_block")
        or _get_known_value(attributes, "destination_ipv6_cidr_block")
        or _get_known_value(attributes, "cidr_block")
        or _get_known_value(attributes, "ipv6_cidr_block")
    )
    route_key = None
    route_value = None
        ...
        if canned_acl == "public-read":
            return [
                S3ACL(
                    S3Permission["READ"],
                    GranteeTypes.GROUP,
                    S3PredefinedGroups.ALL_USERS.value,
                    bucket_name,
                    account,
                    region,
                )
        ...
        if canned_acl == "authenticated-read":
            return [
                S3ACL(
                    S3Permission["READ"],
                    GranteeTypes.GROUP,
                    S3PredefinedGroups.AUTHENTICATED_USERS.value,
                    bucket_name,
                    account,
                    region,
                )
        ...
        if canned_acl == "log-delivery-write":
            return [
                S3ACL(
                    S3Permission["WRITE"],
                    GranteeTypes.GROUP,
                    S3PredefinedGroups.LOG_DELIVERY.value,
                    bucket_name,
                    account,
                    region,
                ),
...
def build_s3_access_point(attributes: dict) -> S3BucketAccessPoint:
    return S3BucketAccessPoint(
        ...
        network_origin=_get_network_origin(
            attributes["network_origin"], attributes["vpc_configuration"]
        ),
        policy=S3AccessPointPolicy(
            attributes["account_id"],
            attributes["region"],
            attributes["name"],
...
def build_s3_public_access_block_settings(
    ...
    bucket_name_or_account_id = (
        ...
        else attributes["account_id"]
    )
    return PublicAccessBlockSettings(
        bucket_name_or_account_id=bucket_name_or_account_id,
...
def build_security_group_rule(attributes: dict) -> List[SecurityGroupRule]:
    ...
    connection_type = (
        ...
        if attributes["type"] == "ingress"
        else ConnectionType.OUTBOUND
    )
...
def build_security_group(attributes: dict, is_default: bool) -> SecurityGroup:
    ...
    if not is_default:
        has_description = attributes.get("description_hashcode") and attributes.get(
...
def build_peering_connection(attributes: dict) -> PeeringConnection:
    return PeeringConnection(
        ...
        accepter_vpc_info=PeeringVpcInfo(
            _get_known_value(attributes, "peer_vpc_id"), []
        ),
...
def build_transit_gateway_route(attributes: dict) -> TransitGatewayRoute:
    ...
    return TransitGatewayRoute(
        destination_cidr_block=attributes["destination_cidr_block"],
...
def build_transit_gateway_route_table(attributes: dict) -> TransitGatewayRouteTable:
    return TransitGatewayRouteTable(
        tgw_id=attributes["transit_gateway_id"],
        route_table_id=attributes["id"],
        region=attributes["region"],
        account=attributes["account_id"],
    )
...
def build_transit_gateway_route_table_association(
    attributes: dict,
) -> TransitGatewayRouteTableAssociation:
    return TransitGatewayRouteTableAssociation(
        attributes["transit_gateway_attachment_id"],
...
def build_transit_gateway_route_table_propagation(
    attributes: dict,
) -> TransitGatewayRouteTablePropagation:
...
def build_vpc_attribute(
    raw_data: dict, assign_default_values: bool
) -> List[VpcAttribute]:
    ...
    enable_dns_hostnames = _get_known_value(
        raw_data, "enable_dns_hostnames", False if assign_default_values else None
    )
    return [
        VpcAttribute(account, region, vpc_id, "EnableDnsSupport", enable_dns_support),
        VpcAttribute(
            account, region, vpc_id, "EnableDnsHostnames", enable_dns_hostnames
        ),
    ]
...
def build_vpc(attributes: dict) -> Vpc:
    ...
    return Vpc(
        ...
        ],  # TODO: What cidr is assigned when this is blank?
        ...
        attributes.get("main_route_table_id"),
...
def build_vpc_endpoint(attributes: dict) -> VpcEndpoint:
    ...
    policy = (
        _build_policy(account, safe_json_loads(attributes["policy"]))
        if _is_known_value(attributes, "policy")
        else full_access_policy
    )
    vpce_type: str = (
        attributes["vpc_endpoint_type"]
        if "vpc_endpoint_type" in attributes
        else "Gateway"
    )
    vpc_endpoint: VpcEndpoint

    if vpce_type == "Gateway":
        vpc_endpoint_gateway: VpcEndpointGateway = VpcEndpointGateway(
            region=region,
            vpc_id=vpc_id,
            account=account,
        ...
        vpc_endpoint_interface: VpcEndpointInterface = VpcEndpointInterface(
            region=region,
            vpc_id=vpc_id,
            account=account,
            service_name=service_name,
        ...
        if isinstance(attributes["network_interface_ids"], list):
            vpc_endpoint_interface.network_interface_ids = attributes[
...
def build_launch_configuration(attributes: dict) -> LaunchConfiguration:
    return LaunchConfiguration(
        ...
        region=attributes["region"],
        account=attributes["account_id"],
        associate_public_ip_address=attributes.get(
            "associate_public_ip_address", False
        ),
        ebs_optimized=_get_known_value(attributes, "ebs_optimized", False),
        monitoring_enabled=attributes.get("enable_monitoring"),
    ).with_aliases(attributes["id"])


def build_auto_scaling_group(attributes: dict) -> AutoScalingGroup:
    launch_template = (
        l_t[0] if (l_t := _get_known_value(attributes, "launch_template", {})) else {}
    )  # pylint: disable=E0601
    ...
    return AutoScalingGroup(
        ...
        launch_configuration_name=attributes["launch_configuration"],
...
def build_rds_cluster_instance(attributes: dict) -> RdsInstance:
    return RdsInstance(
        ...
        performance_insights_kms_key=_get_known_value(
            attributes, "performance_insights_kms_key_id"
        )
        if _get_known_value(attributes, "performance_insights_enabled", False)
        else None,
...
def build_rds_db_instance(attributes: dict) -> RdsInstance:
    ...
    rds_instance.backup_retention_period = _get_known_value(
        attributes, "backup_retention_period", 0
    )
    rds_instance.iam_database_authentication_enabled = _get_known_value(
        attributes, "iam_database_authentication_enabled", False
    )
    rds_instance.cloudwatch_logs_exports = _get_known_value(
        attributes, "enabled_cloudwatch_logs_exports"
    )
    return rds_instance
...
def build_rds_cluster(attributes: dict) -> RdsCluster:
    return RdsCluster(
        ...
        backup_retention_period=_get_known_value(
            attributes, "backup_retention_period", 1
        ),
        engine_type=_get_known_value(attributes, "engine", "aurora"),
        engine_version=_get_known_value(attributes, "engine_version"),
        iam_database_authentication_enabled=_get_known_value(
            attributes, "iam_database_authentication_enabled", False
        ),
        cloudwatch_logs_exports=_get_known_value(
            attributes, "enabled_cloudwatch_logs_exports"
        ),
    )
...
def build_rds_global_cluster(attributes: dict) -> RdsGlobalCluster:
    ...
    return RdsGlobalCluster(
        ...
        encrypted_at_rest=encrypted_at_rest_val,
    ).with_raw_data(_get_known_value(attributes, "source_db_cluster_identifier"))


def _get_network_origin(
    network_origin: str, vpc_config: List
) -> S3BucketAccessPointNetworkOrigin:
...
def _build_policy(account: str, raw_data: dict) -> Optional[Policy]:
    if raw_data is None:
        ...
        statements = [
            build_policy_statement(raw_statement)
            for raw_statement in raw_data["Statement"]
        ]
...
def _add_resource_for_es_domain_policy_statements(
    es_policies: List[PolicyStatement], account: str, region: str, domain_name: str
...
def build_ecs_cluster(attributes: dict) -> EcsCluster:
    ...
    if _is_known_value(attributes, "setting"):
        is_container_insights_enabled = bool(
            attributes["setting"][0]["value"] == "enabled"
        )
...
def build_ecs_target(attributes: dict) -> CloudWatchEventTarget:
    ...
    for event_target_dict in attributes["ecs_target"]:
        ...
        target: EcsTarget = EcsTarget(
            attributes["pulumi_address"] + str(counter),
            attributes["id"],
    ...
    return CloudWatchEventTarget(
        account=attributes["account_id"],
        region=attributes["region"],
        name=attributes["pulumi_address"],
...
def build_ecs_task_definition(attributes: dict) -> EcsTaskDefinition:
    network_mode: NetworkMode = NetworkMode(
        _get_known_value(attributes, "network_mode", "none")
    )
    ...
    for volume in attributes.get("volume", []):
        if volume.get("efs_volume_configuration", []):
            efs_volume_data.append(
                EfsVolume(
                    volume["name"],
                    volume["efs_volume_configuration"][0]["file_system_id"],
                    bool(
                        volume["efs_volume_configuration"][0].get("transit_encryption")
                        == "ENABLED"
                    ),
                )
            )
    ...
    if not ecs_task_definition.container_definitions:
        ecs_task_definition.add_invalidation(
            "failed to retrieve container definitions data"
        )
...
def build_elastic_search_domain(attributes: dict) -> ElasticSearchDomain:
    ...
    encrypt_node_to_node_options = _get_known_value(
        attributes, "node_to_node_encryption"
    )
    ...
    if es_cluster_config:
        es_domain_cluster_instance_type = _get_known_value(
            es_cluster_config[0], "instance_type", "m4.large.elasticsearch"
        )
    ...
    if not _get_known_value(attributes, "access_policies"):
        ...
        _add_resource_for_es_domain_policy_statements(
            policy,
            attributes["account_id"],
            attributes["region"],
            attributes["domain_name"],
        )
        return_statement.policy = ElasticSearchDomainPolicy(
            attributes["domain_name"],
            policy,
...
def build_cloudfront_distribution_list(attributes: dict) -> CloudFrontDistribution:
    ...
    viewer_cert: ViewerCertificate = ViewerCertificate(
    ...
    for cache_behavior_dict in attributes["default_cache_behavior"] + get_dict_value(
        ...
        cache_behavior: CacheBehavior = CacheBehavior(
            allowed_methods=cache_behavior_dict["allowed_methods"],
            ...
            precedence=order,
            field_level_encryption_id=cache_behavior_dict.get(
    ...
    for origin_dict in attributes["origin"]:
        oai_path: str = (
            origin_dict["s3_origin_config"][0]["origin_access_identity"]
            if origin_dict["s3_origin_config"]
            else None
        )
        origin_config: OriginConfig = OriginConfig(
            domain_name=origin_dict["domain_name"],
...
def build_cloudfront_distribution_logging(
    attributes: dict,
) -> CloudfrontDistributionLogging:
...
def origin_access_identity_builder(attributes: dict) -> OriginAccessIdentity:
    return OriginAccessIdentity(
        ...
        attributes["region"],
        attributes["id"],
        attributes["cloudfront_access_identity_path"],
        attributes["iam_arn"],
...
def build_launch_template(attributes: dict) -> LaunchTemplate:
    ...
    security_group_ids = (
        ...
        or _get_known_value(attributes, "security_group_names")
        or []
    )
...
def build_athena_workgroup(attributes: dict) -> AthenaWorkgroup:
    ...
    if encryption_config:
        ...
        kms_key = (
            encryption_config[0].get("kms_key_arn")
            if encryption_config[0].get("kms_key_arn")
            else None
        )
...
def build_rest_api_gw(attributes: dict) -> RestApiGw:
    ...
    if _get_known_value(attributes, "policy"):
        rest_api_gw.resource_based_policy = rest_api_gw.assign_policy_data_for_tf(
            _build_policy_statements_from_str(attributes, "policy"),
            _get_known_value(attributes, "policy"),
            attributes["id"],
        )
...
def build_api_gateway_stage(attributes: dict) -> ApiGatewayStage:
    ...
    if access_logs_data:
        access_logs = AccessLogsSettings(
            access_logs_data[0]["destination_arn"], access_logs_data[0]["format"]
        )
...
def build_dynamodb_table(attributes: dict) -> DynamoDbTable:
    fields: List[TableField] = [
        TableField(field_attr["name"], TableFieldType(field_attr["type"]))
    ...
    return DynamoDbTable(
        ...
        write_capacity=attributes.get("write_capacity") or 0,
        read_capacity=attributes.get("read_capacity") or 0,
...
def build_nat_gateways(attributes: dict) -> NatGateways:
    return NatGateways(
        nat_gateway_id=attributes["id"],
        allocation_id=attributes["allocation_id"],
        subnet_id=attributes["subnet_id"],
        eni_id=attributes["network_interface_id"],
...
def _build_ami_data(attributes: dict):
    ...
    return Ec2Image(
        attributes["id"], is_public, attributes["region"], attributes["account_id"]
    )
...
def build_docdb_cluster_parameter_group(attributes: dict) -> DocDbClusterParameterGroup:
    ...
    for parameter in attributes["parameter"]:
        list_parameters.append(
            DocDbClusterParameter(parameter.get("name"), parameter.get("value"))
        )
    return DocDbClusterParameterGroup(
        ...
        attributes["account_id"],
        attributes["region"],
    ).with_raw_data(attributes.get("id"))
...
def build_s3_bucket_encryption(attributes: dict) -> S3BucketEncryption:
    ...
    return S3BucketEncryption(
        attributes["bucket"], encrypted, attributes["region"], attributes["account_id"]
    )
...
def build_s3_bucket_versioning(attributes: dict) -> S3BucketVersioning:
    versioning = False
    if (
        _get_known_value(attributes, "versioning") is not None
        and attributes["versioning"][0]["enabled"]
    ):
        versioning = True
    return S3BucketVersioning(
        attributes["bucket"], versioning, attributes["account_id"], attributes["region"]
    )


def build_s3_bucket_object(attributes: dict) -> S3BucketObject:
    encrypted = False
    if attributes["server_side_encryption"] and attributes[
        "server_side_encryption"
    ] in ["AES256", "aws:kms"]:
        encrypted = True
...
def build_vpc_endpoint_route_table_association(
    attributes: dict,
) -> VpcEndpointRouteTableAssociation:
    return VpcEndpointRouteTableAssociation(
        attributes["route_table_id"],
        attributes["vpc_endpoint_id"],
        attributes["region"],
        attributes["account_id"],
    )
...
def build_sqs_queue(attributes: dict) -> SqsQueue:
    ...
    if _get_known_value(attributes, "policy"):
        return_statement.policy = SqsQueuePolicy(
            attributes.get("name"),
            _build_policy_statements_from_str(attributes, "policy"),
            _get_known_value(attributes, "policy"),
            attributes["account_id"],
...
def build_elasti_cache_replication_group(
    attributes: dict,
) -> ElastiCacheReplicationGroup:
    elacticache_replication_group = ElastiCacheReplicationGroup(
        attributes["replication_group_id"],
        _get_known_value(attributes, "at_rest_encryption_enabled", False),
        _get_known_value(attributes, "transit_encryption_enabled", False),
        attributes["region"],
        attributes["account_id"],
    )
    elacticache_replication_group.subnet_group_name = _get_known_value(
        attributes, "subnet_group_name", "default"
    )
    elacticache_replication_group.elasticache_security_group_ids = _get_known_value(
        attributes, "security_group_ids"
    )
    elacticache_replication_group.is_in_default_vpc = (
        elacticache_replication_group.subnet_group_name == "default"
        or not elacticache_replication_group.subnet_group_name
    )
    elacticache_replication_group.with_aliases(
        attributes["id"],
        attributes["replication_group_id"]
        + attributes["account_id"]
        + attributes["region"],
...
def build_sqs_queue_policy(attributes: dict) -> SqsQueuePolicy:
    ...
    return SqsQueuePolicy(
        attributes["queue_url"].split("/")[-1]
        if "/" in attributes["queue_url"]
        else attributes["queue_url"],
        policy_statements,
        _get_known_value(attributes, "policy"),
        attributes["account_id"],
    )
...
def build_ecr_repository(attributes: dict) -> EcrRepository:
    ...
    if encryption_settings:
        encryption_type = (
            "AES256"
            if encryption_settings[0].get("encryption_type") is None
            else encryption_settings[0]["encryption_type"]
        )
...
def build_cloudwatch_logs_policy_destination(
    attributes: dict,
) -> CloudWatchLogsDestinationPolicy:
    return CloudWatchLogsDestinationPolicy(
...
def build_elastic_search_domain_policy(attributes: dict) -> ElasticSearchDomainPolicy:
    ...
    return ElasticSearchDomainPolicy(
        attributes["domain_name"], policy, raw_document, attributes["account_id"]
    )
...
def build_lambda_function(attributes: dict) -> LambdaFunction:
    ...
    for vpc_config_dict in attributes["vpc_config"]:
        if vpc_config is None:
            vpc_config = NetworkConfiguration(
                False,
                vpc_config_dict["security_group_ids"],
...
def build_lambda_policy(attributes: dict) -> LambdaPolicy:
    condition_block: List[StatementCondition] = (
        [StatementCondition("ArnLike", "AWS:SourceArn", [attributes.get("source_arn")])]
        if attributes.get("source_arn", None)
        else []
    )
    if attributes.get("source_account", None):
        condition_block.append(
            StatementCondition(
                "StringEquals", "AWS:SourceAccount", [attributes.get("source_account")]
            )
        )
    ...
    statement: PolicyStatement = PolicyStatement(
        ...
        resources=[
            create_lambda_function_arn(
                account, attributes["region"], attributes["function_name"], qualifier
            )
        ],
        principal=principal,
...
def build_glacier_vault_policy(attributes: dict) -> GlacierVaultPolicy:
    policy = []
    if attributes.get("access_policy") and isinstance(
        json.loads(attributes["access_policy"]), dict
    ):
...
def build_xray_encryption(attributes: dict) -> XrayEncryption:
    return XrayEncryption(
        attributes.get("key_id"), attributes["region"], attributes["account_id"]
    )
...
def build_kinesis_firehose_stream(attributes: dict) -> KinesisFirehoseStream:
    ...
    if _get_known_value(attributes, "elasticsearch_configuration"):
        ...
        if _get_known_value(es_domain_config, "vpc_config"):
            ...
            es_vpc_config = NetworkConfiguration(
                False,
                es_vpc_configurations["security_group_ids"],
                es_vpc_configurations["subnet_ids"],
            )
...
def build_iam_password_policy(attributes: dict) -> IamPasswordPolicy:
    return IamPasswordPolicy(
        _get_known_value(attributes, "minimum_password_length"),
...
def build_dms_replication_instance_subnet_group(
    attributes: dict,
) -> DmsReplicationInstanceSubnetGroup:
    replication_subnet_group_id = attributes["replication_subnet_group_id"]
    return DmsReplicationInstanceSubnetGroup(
        attributes["account_id"],
        attributes["region"],
        ...
        attributes["id"],
        replication_subnet_group_id + attributes["account_id"] + attributes["region"],
    )
...
def build_workspaces_directory(attributes: dict) -> WorkspaceDirectory:
    security_group_ids_value = _get_known_value(
        attributes, "workspace_security_group_id"
    )
    if security_group_ids_value:
        security_group_ids = [
            _get_known_value(attributes, "workspace_security_group_id")
        ]
    else:
        security_group_ids = []
    if _get_known_value(
        attributes, "workspace_creation_properties"
    ) and _get_known_value(
        attributes["workspace_creation_properties"][0], "custom_security_group_id"
    ):
        security_group_ids.append(
            _get_known_value(
                attributes["workspace_creation_properties"][0],
...
def build_directory_service(attributes: dict) -> DirectoryService:
    ...
    if vpc_settings:
        vpc_config = NetworkConfiguration(
            False, security_group_ids, attributes["vpc_settings"][0]["subnet_ids"]
        )
        vpc_id = attributes["vpc_settings"][0]["vpc_id"]
    else:
        vpc_config = NetworkConfiguration(
            False, security_group_ids, attributes["connect_settings"][0]["subnet_ids"]
        )
...
def build_load_balancer_attributes(attributes: dict) -> LoadBalancerAttributes:
    ...
    if lb_access_logs_raw_data:
        lb_access_logs = LoadBalancerAccessLogs(
            lb_access_logs_raw_data[0]["bucket"]
            if lb_access_logs_raw_data[0]["bucket"]
            else "",
            lb_access_logs_raw_data[0]["prefix"]
            if lb_access_logs_raw_data[0]["prefix"] is not None
            else "",
            lb_access_logs_raw_data[0]["enabled"]
            if lb_access_logs_raw_data[0]["prefix"] is not None
            else False,
        )
...
def build_batch_compute_environment(attributes: dict) -> BatchComputeEnvironment:
    ...
    if batch_settings:
        vpc_config = NetworkConfiguration(
            False, batch_settings[0]["security_group_ids"], batch_settings[0]["subnets"]
        )
...
def build_emr_cluster(attributes: dict) -> EmrCluster:
    ...
    if ec2_settings:
        ...
        additional_master_security_groups = ec2_settings[0].get(
            "additional_master_security_groups"
        )
        if additional_master_security_groups:
            if "," in additional_master_security_groups:
                additional_master_security_groups = (
                    additional_master_security_groups.split(",")
                )
            else:
        ...
        additional_slave_security_groups = ec2_settings[0].get(
            "additional_slave_security_groups"
        )
        if additional_slave_security_groups:
            if "," in additional_slave_security_groups:
                additional_slave_security_groups = (
                    additional_slave_security_groups.split(",")
                )
            else:
...
def build_global_accelerator(attributes: dict) -> GlobalAccelerator:
    return GlobalAccelerator(
        attributes["account_id"], attributes["name"], attributes["id"]
    )


def build_global_accelerator_listener(attributes: dict) -> GlobalAcceleratorListener:
    return GlobalAcceleratorListener(
        attributes["account_id"], attributes["id"], attributes["accelerator_arn"]
    )


def build_global_accelerator_endpoint_group(
    attributes: dict,
) -> GlobalAcceleratorEndpointGroup:
...
def build_s3outpost_endpoint(attributes: dict) -> S3OutpostEndpoint:
    return S3OutpostEndpoint(
        ...
        attributes["region"],
        NetworkConfiguration(
            False, [attributes["security_group_id"]], [attributes["subnet_id"]]
        ),
    )
...
def build_worklink_fleet(attributes: dict) -> WorkLinkFleet:
    ...
    if vpc_settings:
        vpc_config = NetworkConfiguration(
            False, vpc_settings[0]["security_group_ids"], vpc_settings[0]["subnet_ids"]
        )
...
def build_glue_connection(attributes: dict) -> GlueConnection:
    ...
    if vpc_settings:
        vpc_config = NetworkConfiguration(
            False,
            _get_known_value(vpc_settings[0], "security_group_id_list"),
            [vpc_settings[0]["subnet_id"]],
        )
...
def build_config_aggregator(attributes: dict) -> ConfigAggregator:
    ...
    if _get_known_value(attributes, "account_aggregation_source"):
        ...
        account_aggregation_all_regions_enabled = attributes[
            "account_aggregation_source"
        ][0]["all_regions"]
    if _get_known_value(attributes, "organization_aggregation_source"):
        organization_aggregation_used = True
        organization_aggregation_all_regions_enabled = attributes[
...
def build_global_accelerator_attribute(attributes: dict) -> GlobalAcceleratorAttribute:
    ...
    return GlobalAcceleratorAttribute(
        attributes["account_id"],
        flow_logs_enabled,
        flow_logs_s3_bucket,
        flow_logs_s3_prefix,
