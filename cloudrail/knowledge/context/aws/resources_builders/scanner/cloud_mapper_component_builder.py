...
def build_ecs_task_definition(attributes: dict) -> EcsTaskDefinition:
    ...
    ecs_task_definition = EcsTaskDefinition(task_arn=attributes['taskDefinitionArn'], family=attributes['family'], 
                                            revision=attributes['revision'], account=account, region=region, 
