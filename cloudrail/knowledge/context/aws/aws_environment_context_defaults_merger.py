...
class AwsEnvironmentContextDefaultsMerger:
    ...
    def _merge_vpc_attributes(scanner_ctx: AwsEnvironmentContext, iac_ctx: AwsEnvironmentContext):
        ...
        existing_attributes = [attribute for attribute in scanner_ctx.vpcs_attributes if (scanner_ctx.vpcs + iac_ctx.vpcs).get(attribute.vpc_id) and (scanner_ctx.vpcs + iac_ctx.vpcs)[attribute.vpc_id].is_default]
