...
from cloudrail.knowledge.context.gcp.resources.compute.gcp_compute_instance import GcpComputeInstance, GcpComputeInstanceBootDisk, GcpComputeInstanceBootDiskMode, GcpComputeInstanceBootDiskInitPrarams, GcpComputeInstanceBootDiskInitPraramsType, GcpComputeInstanceNetworkInterface, GcpComputeInstanceNetIntfAccessCfg, GcpComputeInstanceNetIntfAliasIpRange, GcpComputeInstanceNetIntfNicType, GcpComputeInstanceAttachedDisk, GcpComputeInstanceAttachDiskMode, GcpComputeInstanceGuestAccelerator, GcpComputeInstanceScheduling, GcpComputeInstanceNodeAffinity, GcpComputeInstanceScratchDisk, GcpComputeInstanceServiceAcount, GcpComputeInstanceShieldInstCfg, GcpComputeInstanceResvAffinity, GcpComputeInstanceSpecificResv, GcpComputeInstanceConfInstCfg, GcpComputeInstanceAdvMachineFeatures, GcpComputeInstanceNetPerfCfg
