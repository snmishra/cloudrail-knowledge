...
from cloudrail.knowledge.utils.utils import is_first_octet_in_range
    ...
    def _update_object_properties(src_obj, target_obj):
        for attr in dir(src_obj):
            if '__' not in attr:
                ...
                if src_val is None or (isinstance(src_val, str) and 'cfn-pseudo' in src_val) or is_first_octet_in_range(src_val, (11,171)):
