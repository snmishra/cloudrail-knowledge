...
those classes that inherit from [ConnectionInstance](https://github.com/indeni/cloudrail-knowledge/blob/feature/azure/CR-2460-VM_publicly_access_rdp/cloudrail/knowledge/context/connection.py).
