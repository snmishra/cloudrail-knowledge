...
class TestGlueDataCatalogPolicy(AwsContextTest):
    ...
    @context(module_path="not_secure_policy", test_options=TestOptions(tf_version='', run_latest_provider=False))
    ...
    @context(module_path="secure_policy", test_options=TestOptions(always_use_cache_on_jenkins=True, tf_version='>3.13.0'))
