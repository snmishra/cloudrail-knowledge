...
class TestWorkspaces(AwsContextTest):
    ...
    @context(module_path="root_volume_encrypted_at_rest", test_options=TestOptions(always_use_cache_on_jenkins=True))
    ...
    @context(module_path="root_volume_not_encrypted_at_rest", test_options=TestOptions(always_use_cache_on_jenkins=True))
    ...
    @context(module_path="user_volume_encrypted_at_rest", test_options=TestOptions(always_use_cache_on_jenkins=True))
    ...
    @context(module_path="user_volume_not_encrypted_at_rest", test_options=TestOptions(always_use_cache_on_jenkins=True))
    ...
    @context(module_path="user_volume_encrypted_with_aws_managed_cmk", test_options=TestOptions(always_use_cache_on_jenkins=True))
    ...
    @context(module_path="user_volume_encrypted_with_customer_managed_cmk_creating_key", test_options=TestOptions(always_use_cache_on_jenkins=True))
    ...
    @context(module_path="with_tags", test_options=TestOptions(always_use_cache_on_jenkins=True))
