...
class TestNeptuneCluster(AwsContextTest):
    ...
    @context(module_path="encrypted_at_rest_with_aws_managed_cmk", base_scanner_data_for_iac='account-data-ssm-param-kms-keys', test_options=TestOptions(always_use_cache_on_jenkins=True))
