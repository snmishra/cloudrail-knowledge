...
class TestMqBroker(AwsContextTest):
    ...
    @context(module_path="basic_default", base_scanner_data_for_iac='account-data-dms-instance-networking',
    ...
    @context(module_path="default_vpc_multi_az", base_scanner_data_for_iac='account-data-dms-instance-networking',
             test_options=TestOptions(always_use_cache_on_jenkins=True))
