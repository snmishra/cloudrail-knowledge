from cloudrail.knowledge.context.connection import PortConnectionProperty, ConnectionDetail, PolicyConnectionProperty, PrivateConnectionDetail
...
from cloudrail.knowledge.context.aws.iam.policy_statement import PolicyStatement, StatementEffect, StatementCondition
from cloudrail.knowledge.context.aws.iam.principal import PrincipalType
from cloudrail.knowledge.context.aws.aws_environment_context import AwsEnvironmentContext

from core.utils.policy_evaluator import PolicyEvaluation, get_allowed_actions, is_any_action_allowed
...
class TestLambdaFunction(AwsContextTest):
    ...
    @context(module_path="lambda-without-permissions")
    ...
    @context(module_path="lambda-permissions")
    ...
    @context(module_path="lambda-alias")
    ...
    @context(module_path="lambda-inbound-permissions")
    ...
    @context(module_path="lambda-without-inbound-permissions")
    ...
    @context(module_path="lambda-vpc-configuration")
    ...
    @context(module_path="lambda-outbound-connections")
    ...
    @context(module_path="lambda-outbound-permissions-connections")
    ...
    @context(module_path="lambda-outbound-connections-mismatch")
    ...
    @context(module_path="lambda-filter-un-used-versions")
