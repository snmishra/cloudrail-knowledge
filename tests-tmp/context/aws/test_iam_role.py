...
class TestIamRole(AwsContextTest):
    ...
    @context(module_path="assume-role-inline-policy", test_options=TestOptions(always_use_cache_on_jenkins=True))
    ...
    @context(module_path="role-nested-inline-policy", test_options=TestOptions(always_use_cache_on_jenkins=True))
    ...
    @context(module_path="testing_dates", base_scanner_data_for_iac='account-data-iam-role-last-used',
             test_options=TestOptions(use_state_file=True, always_use_cache_on_jenkins=True))
