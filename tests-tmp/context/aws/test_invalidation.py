...
class TestInvalidation(AwsContextTest):
    ...
    @context(module_path="cm_test_missing_vpc", test_options=TestOptions(tf_version='', run_latest_provider=False))
    ...
    @context(module_path="tf_test_missing_vpc_and_sg", test_options=TestOptions(run_cloudmapper=False, always_use_cache_on_jenkins=True))
    ...
    @context(module_path="missing_default_vpc", test_options=TestOptions(run_cloudmapper=False, always_use_cache_on_jenkins=True),
