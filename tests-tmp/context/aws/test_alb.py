...
from cloudrail.knowledge.context.aws.elb.load_balancer import LoadBalancerType, LoadBalancerSchemeType, LoadBalancer
...
class TestAlb(AwsContextTest):
    ...
    @context(module_path="simple_basic_case_with_default_subnet", test_options=TestOptions(always_use_cache_on_jenkins=True))
    ...
    @context(module_path="internal_case", test_options=TestOptions(always_use_cache_on_jenkins=True))
