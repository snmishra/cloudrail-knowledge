from core.entities.exceptions import UnknownResultOfTerraformApply
...
class TestIamPolicyAttachment(AwsContextTest):
    ...
    @context(module_path="iam_policy_attachment_raise_exception",
             test_options=TestOptions(run_cloudmapper=False, expected_exception=UnknownResultOfTerraformApply))
