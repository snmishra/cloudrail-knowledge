...
class TestIamRole(AwsContextTest):
    ...
    @context(module_path="iam_multiple_issues", test_options=TestOptions(run_cloudmapper=False, always_use_cache_on_jenkins=True))
    ...
    @context(module_path="iam_security_issues", test_options=TestOptions(run_cloudmapper=False, always_use_cache_on_jenkins=True))
