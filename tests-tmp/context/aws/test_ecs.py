...
from cloudrail.knowledge.context.connection import ConnectionDetail, PortConnectionProperty, ConnectionType, PrivateConnectionDetail, \
    PolicyConnectionProperty, PolicyEvaluation
from cloudrail.knowledge.context.aws.cloudwatch.cloud_watch_event_target import CloudWatchEventTarget
from cloudrail.knowledge.context.aws.ecs.ecs_constants import LaunchType, NetworkMode
...
from cloudrail.knowledge.context.aws.ecs.ecs_task_definition import EcsTaskDefinition, ContainerDefinition, PortMappings
...
from core.utils.policy_evaluator import is_any_action_allowed
...
class TestEcs(AwsContextTest):
    ...
    @context(module_path="fargate/ecs-task-definition", test_options=TestOptions(always_use_cache_on_jenkins=True))
