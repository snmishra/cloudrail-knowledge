...
class TestSqlDatabaseSslRequiredRule(GcpBaseRuleTest):
    ...
    def test_ssl_required_false(self):
        self.run_test_case('ssl_required_false', should_alert=True, always_use_cache_on_jenkins=True)

    def test_ssl_required_true(self):
        self.run_test_case('ssl_required_true', should_alert=False, always_use_cache_on_jenkins=True)

    def test_ssl_required_not_specified(self):
        self.run_test_case('ssl_required_not_specified', should_alert=True, always_use_cache_on_jenkins=True)
