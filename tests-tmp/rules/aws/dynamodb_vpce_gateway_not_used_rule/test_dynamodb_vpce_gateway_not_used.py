...
class TestDynamoDbVpceGatewayNotUsed(AwsBaseRuleTest):
    ...
    def test_vpc_instance_has_direct_dynamodb_service_connection(self):
        self.run_test_case('vpc_instance_has_direct_dynamodb_service_connection', True, always_use_cache_on_jenkins=True)
    ...
    def test_vpc_do_not_have_dynamodb_tables_in_region(self):
        self.run_test_case('vpc-do-not-have-dynamodb-tables-in-region', False, always_use_cache_on_jenkins=True)

    def test_vpc_has_dynamodb_vpce_gw_and_public_connection(self):
        self.run_test_case('vpc_has_dynamodb_vpce_gw_and_public_connection', False, always_use_cache_on_jenkins=True)

    def test_vpc_has_only_dynamodb_vpce_gw_connection(self):
        self.run_test_case('vpc_has_only_dynamodb_vpce_gw_connection', False, always_use_cache_on_jenkins=True)
