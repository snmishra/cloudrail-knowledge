...
class TestEnsureNoUnusedSecurityGroups(AwsBaseRuleTest):
    ...
    def test_rds_unused_security_group_existing(self):
        self.run_test_case('rds/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_elasticache_unused_security_group_existing(self):
        self.run_test_case('elasticache/cluster_unused_security_group_existing', True, use_state_file=True)
    ...
    def test_replication_group_unused_security_group_existing(self):
        self.run_test_case('elasticache/replication_group_unused_security_group_existing', True, use_state_file=True)
    ...
    def test_redshift_unused_security_group_existing(self):
        self.run_test_case('redshift/unused_security_group_existing', True, use_state_file=True, always_use_cache_on_jenkins=True)
    ...
    def test_ec2_unused_security_group_existing(self):
        self.run_test_case('ec2/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_eks_unused_security_group_existing(self):
        self.run_test_case('eks/unused_security_group_existing', True, use_state_file=True)

    # launch template resources #
    def test_launch_template_used_security_group(self):
        self.run_test_case('launch_template/used_security_group', False, always_use_cache_on_jenkins=True)

    def test_launch_template_unused_security_group_new(self):
        self.run_test_case('launch_template/unused_security_group_new', False, always_use_cache_on_jenkins=True)

    def test_launch_template_unused_security_group_existing(self):
        self.run_test_case('launch_template/unused_security_group_existing', True, 2, use_state_file=True, always_use_cache_on_jenkins=True)
    ...
    def test_load_balancer_unused_security_group_existing(self):
        self.run_test_case('load_balancer/unused_security_group_existing', True, use_state_file=True, always_use_cache_on_jenkins=True)
    ...
    def test_efs_unused_security_group_existing(self):
        self.run_test_case('efs_mount_target/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_ecs_unused_security_group_existing(self):
        self.run_test_case('ecs/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_launch_configuration_unused_security_group_existing(self):
        self.run_test_case('launch_configuration/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_lambda_function_unused_security_group_existing(self):
        self.run_test_case('lambda_function/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_elastic_search_domain_unused_security_group_existing(self):
        self.run_test_case('elastic_search_domain/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_codebuild_project_unused_security_group_existing(self):
        self.run_test_case('codebuild_project/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_neptune_unused_security_group_existing(self):
        self.run_test_case('neptune/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_kinesis_firehose_unused_security_group_existing(self):
        self.run_test_case('kinesis_firehose/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_dms_unused_security_group_existing(self):
        self.run_test_case('dms/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_workspace_directory_unused_security_group_existing(self):
        self.run_test_case('workspace_directory/unused_security_group_existing', True, 2, use_state_file=True, always_use_cache_on_jenkins=True)
    ...
    def test_batch_unused_security_group_existing(self):
        self.run_test_case('batch_compute/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_mq_broker_unused_security_group_existing(self):
        self.run_test_case('mq_broker/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_api_gateway_v2_unused_security_group_existing(self):
        self.run_test_case('api_gateway_v2/unused_security_group_existing', True, use_state_file=True)

    # EMR cluster resources #
    def test_emr_cluster_used_security_group(self):
        self.run_test_case('emr_cluster/used_security_group', False, always_use_cache_on_jenkins=True)

    def test_emr_cluster_unused_security_group_new(self):
        self.run_test_case('emr_cluster/unused_security_group_new', False, always_use_cache_on_jenkins=True)

    def test_emr_cluster_unused_security_group_existing(self):
        self.run_test_case('emr_cluster/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_global_accelerator_unused_security_group_existing(self):
        self.run_test_case('global_accelerator/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_cloudhsm_v2_cluster_unused_security_group_existing(self):
        self.run_test_case('cloudhsm_v2_cluster/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_worklink_fleet_cluster_unused_security_group_existing(self):
        self.run_test_case('worklink_fleet/unused_security_group_existing', True, use_state_file=True)
    ...
    def test_glue_connection_cluster_unused_security_group_existing(self):
        self.run_test_case('glue_connection/unused_security_group_existing', True, use_state_file=True)

    # Simple standalone security group #
    def test_one_sg(self):
        self.run_test_case('one_sg', True, use_state_file=True)
