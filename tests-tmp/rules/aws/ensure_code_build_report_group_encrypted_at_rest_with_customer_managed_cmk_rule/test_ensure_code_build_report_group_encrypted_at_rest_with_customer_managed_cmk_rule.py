...
class TestEnsureCodeBuildReportGRoupEncryptedCustomerManagedCmkRule(AwsBaseRuleTest):
    ...
    def test_encrypted_at_rest_with_aws_managed_key_by_key_arn(self):
        self.run_test_case('encrypted_at_rest_with_aws_managed_key_by_key_arn', True, always_use_cache_on_jenkins=True)

    def test_encrypted_at_rest_with_customer_managed_key_creating_key(self):
        self.run_test_case('encrypted_at_rest_with_customer_managed_key_creating_key', False, always_use_cache_on_jenkins=True)

    def test_encrypted_at_rest_with_customer_managed_key_existing_key(self):
        self.run_test_case('encrypted_at_rest_with_customer_managed_key_existing_key', False, always_use_cache_on_jenkins=True)
