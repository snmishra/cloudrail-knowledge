...
class TestEnsureWorkspaceUserVolumeEncryptedAtRestRule(AwsBaseRuleTest):
    ...
    def test_user_volume_encrypted_at_rest(self):
        self.run_test_case('user_volume_encrypted_at_rest', False, always_use_cache_on_jenkins=True)

    def test_user_volume_not_encrypted_at_rest(self):
        self.run_test_case('user_volume_not_encrypted_at_rest', True, always_use_cache_on_jenkins=True)
