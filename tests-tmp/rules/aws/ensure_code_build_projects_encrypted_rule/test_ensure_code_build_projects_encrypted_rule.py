...
class TestEnsureCodeBuildProjectsEncryptedRule(AwsBaseRuleTest):
    ...
    def test_encrypted_aws_key_arn(self):
        self.run_test_case('encrypted_aws_key_arn', True, always_use_cache_on_jenkins=True)

    def test_encrypted_existing_customer_key(self):
        self.run_test_case('encrypted_existing_customer_key', False, always_use_cache_on_jenkins=True)
