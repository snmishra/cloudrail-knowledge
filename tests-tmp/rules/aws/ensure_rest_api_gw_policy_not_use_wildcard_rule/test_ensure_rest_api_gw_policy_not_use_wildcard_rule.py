...
class TestEnsureRestApiGwPolicyNotUseWildcard(AwsBaseRuleTest):
    ...
    def test_not_secure_policy(self):
        ...
        self.assertEqual(rule_result.issue_items[0].exposed.type, 'API Gateway')
        self.assertEqual(rule_result.issue_items[0].violating.type, 'API Gateway resource policy')
