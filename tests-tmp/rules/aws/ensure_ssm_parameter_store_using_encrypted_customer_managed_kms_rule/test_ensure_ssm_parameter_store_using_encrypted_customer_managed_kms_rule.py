...
class TestEnsureSsmParameterStoreUsingEncryptedCustomerManagedKmsRule(AwsBaseRuleTest):
    ...
    def test_encrypted_aws_managed_key_arn(self):
        self.run_test_case('encrypted_aws_managed_key_arn', True, always_use_cache_on_jenkins=True)
    ...
    def test_encrypted_customer_kms_existing_key(self):
        self.run_test_case('encrypted_customer_kms_existing_key', False, always_use_cache_on_jenkins=True)
