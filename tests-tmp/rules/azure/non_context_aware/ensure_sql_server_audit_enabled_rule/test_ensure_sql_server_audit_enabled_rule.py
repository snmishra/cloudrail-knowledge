...
class TestEnsureSqlServerAuditEnabledRule(AzureBaseRuleTest):
    ...
    def test_audit_enabled_extended_block_retention_90(self):
        ...
        self.assertTrue('has auditing enabled, but for less than 90 days of retention' in rule_result.issue_items[0].evidence)
    ...
    def test_audit_not_enabled(self):
        ...
        self.assertTrue('does not have auditing enabled' in rule_result.issue_items[0].evidence)
