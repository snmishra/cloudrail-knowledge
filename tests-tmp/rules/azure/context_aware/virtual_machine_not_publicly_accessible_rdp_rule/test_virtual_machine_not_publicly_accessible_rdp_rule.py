...
class TestVirtualMachineNotPubliclyAccessibleRdpRule(AzureBaseRuleTest):
    ...
    def test_vm_public_rdp_pip_opened_020(self):
        ...
        self.assertIn(violating_nsg_rule_address, rule_result.issue_items[0].evidence)
        self.assertEqual(violating_nsg_rule_address, rule_result.issue_items[0].violating.iac_entity_id)
