# pip attached, nsg attached to nic with only default rules which block access from the internet
# nsg attached to subnet with only default rules which block access from the internet
# port is closed
