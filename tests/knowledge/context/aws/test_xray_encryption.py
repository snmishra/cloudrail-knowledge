...
class TestXrayEncryption(AwsContextTest):
    ...
    @context(module_path="kms_key_arn_aws_managed", base_scanner_data_for_iac='account-data-existsing-keys-xray/kms_key_arn_aws_managed.zip',
    ...
    @context(module_path="kms_key_customer_existing", base_scanner_data_for_iac='account-data-existsing-keys-xray/kms_key_customer_existing.zip',
             test_options=TestOptions(tf_version='>v3.4.0'))
