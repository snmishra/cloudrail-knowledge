...
locals {
  name         = "cloudfront-dist-field-level-encryption-cloudrail-ct-test"
  s3_origin_id = "cloudfront-dist-field-level-encryption-bucket"
}
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  default_cache_behavior {
    ...
    field_level_encryption_id = "C1PK6QC98QYY9J"
