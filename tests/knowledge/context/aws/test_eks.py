...
class TestEks(AwsContextTest):
    ...
    # Not running drift as unable to create drift data - unable to use the TF module to create drift data.
    @context(module_path="basic", test_options=TestOptions(tf_version='>=3.10', run_drift_detection=False))
