...
class TestComputeTargetSslProxy(GcpContextTest):
    ...
    def test_basic(self, ctx: GcpEnvironmentContext):
        ...
        if compute.origin == EntityOrigin.LIVE_ENV:
            ...
            self.assertEqual(compute.ssl_policy, "https://www.googleapis.com/compute/v1/projects/dev-for-tests/global/sslPolicies/ssl-policy")
            ...
            self.assertEqual(compute.ssl_policy, "ssl-policy")
