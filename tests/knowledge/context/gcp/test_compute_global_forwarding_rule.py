...
class TestComputeGlobalForwardingRule(GcpContextTest):
    ...
    def test_basic(self, ctx: GcpEnvironmentContext):
        ...
        self.assertTrue(compute.target_identifier in ['google_compute_global_forwarding_rule.https-forwarding.target',
        ...
        self.assertIsNotNone(compute)
        self.assertTrue(compute.target_identifier in ['google_compute_global_forwarding_rule.ssl-forwarding.target',
