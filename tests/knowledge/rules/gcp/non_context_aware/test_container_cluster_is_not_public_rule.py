...
class TestContainerClusterEnsureNoPublicIptRule(TestCase):
    def setUp(self):
        self.rule = ContainerClusterEnsureNoPublicIptRule()
    ...
    def test_compute_instance_public_ip(self, unused_name: str, cidr_blocks: dict, total_issues: int, rule_status: RuleResultType):
        # Arrange
