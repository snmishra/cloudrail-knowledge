...
resource "aws_emr_cluster" "test" {
  ...
  ec2_attributes {
    ...
    additional_master_security_groups = "${aws_security_group.additional_master_1.id},${aws_security_group.additional_master_2.id}"
    emr_managed_slave_security_group  = aws_security_group.slave.id
    additional_slave_security_groups  = "${aws_security_group.additional_slave_1.id},${aws_security_group.additional_slave_2.id}"
