...
resource "aws_route_table" "private-rtb" {
  ...
  route {
    ...
    gateway_id = aws_vpc_endpoint.secondary-dynamodb-vpce-gw.id
  }
...
resource "aws_vpc_endpoint" "secondary-dynamodb-vpce-gw" {
...
resource "aws_vpc_endpoint_route_table_association" "vpce-gw-to-private-rtb-assoc" {
  route_table_id  = aws_route_table.private-rtb.id
  vpc_endpoint_id = aws_vpc_endpoint.secondary-dynamodb-vpce-gw.id
}
