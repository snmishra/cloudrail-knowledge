...
locals {
  ...
  s3_origin_id = "cloudfront-dist-encrypted-bucket"
}
...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  origin {
    ...
    s3_origin_config {
      origin_access_identity = join("", ["origin-access-identity/cloudfront/", aws_cloudfront_origin_access_identity.oai.id])
    }
  }
