...
from cloudrail.knowledge.rules.azure.non_context_aware.app_service_non_car_web_app_using_latest_python_version_rule import \
    AppServiceUseLatestPythonVersionRule
...
class TestAppServiceUseLatestPythonVersionRule(TestCase):
    ...
    def setUp(self):
        self.rule = AppServiceUseLatestPythonVersionRule()
    ...
    def test_non_car_web_app_using_latest_python_version(self, unused_name: str, linux_fx_version: str, should_alert: bool):
        # Arrange
