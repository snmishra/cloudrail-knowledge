...
from cloudrail.knowledge.rules.azure.non_context_aware.defender_for_container_registries_enabled_rule import DefenderForContainerRegistriesEnabledRule
...
class TestDefenderForContainerRegistriesEnabled(unittest.TestCase):
    def setUp(self):
        self.rule = DefenderForContainerRegistriesEnabledRule()
