...
from cloudrail.knowledge.rules.azure.non_context_aware.monitor_activity_log_alert_exists_rule import PolicyAssignmentMonitorActivityLogAlertExistsRule
from cloudrail.knowledge.rules.base_rule import RuleResultType


class TestPolicyAssignmentMonitorActivityLogAlertExistsRule(TestCase):
    def setUp(self):
        self.rule = PolicyAssignmentMonitorActivityLogAlertExistsRule()
    ...
    def test_policy_assignment_monitor_activity_log_alert_exists_rule(self, unused_name: str, enabled: bool, category: str, operations_name_exists: bool, total_issues: int, rule_status: RuleResultType):
        # Arrange
