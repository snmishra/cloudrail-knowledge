...
from cloudrail.knowledge.rules.azure.non_context_aware.defender_enabled_rules import KeyVaultsDefenderEnabled


class TestKeyVaultsDefenderEnabled(unittest.TestCase):
    def setUp(self):
        self.rule = KeyVaultsDefenderEnabled()
