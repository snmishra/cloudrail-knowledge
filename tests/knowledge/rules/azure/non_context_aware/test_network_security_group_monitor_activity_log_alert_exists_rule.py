...
class TestNetworkSecurityGroupMonitorActivityLogAlertExistsRule(TestCase):
    def setUp(self):
        self.rule = NetworkSecurityGroupMonitorActivityLogAlertExistsRule()
    ...
    def test_network_security_group_monitor_activity_log_alert_exists_rule(self, unused_name: str, enabled: bool, category: str, operations_name_exists: bool, total_issues: int, rule_status: RuleResultType):
        # Arrange
