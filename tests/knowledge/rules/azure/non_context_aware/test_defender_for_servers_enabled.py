...
from cloudrail.knowledge.rules.azure.non_context_aware.defender_enabled_rules import ServersDefenderEnabled


class TestServersEnabled(unittest.TestCase):
    def setUp(self):
        self.rule = ServersDefenderEnabled()
