...
from cloudrail.knowledge.rules.azure.non_context_aware.monitor_activity_log_alert_exists_rule import SecurityPolicyMonitorActivityLogAlertExistsRule
from cloudrail.knowledge.rules.base_rule import RuleResultType


class TestSecurityPolicyMonitorActivityLogAlertExistsRule(TestCase):
    def setUp(self):
        self.rule = SecurityPolicyMonitorActivityLogAlertExistsRule()
    ...
    def test_security_policy_monitor_activity_log_alert_exists_rule(self, unused_name: str, enabled: bool, category: str, operations_name_exists: bool, total_issues: int, rule_status: RuleResultType):
        # Arrange
