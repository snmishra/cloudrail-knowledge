...
from cloudrail.knowledge.rules.azure.non_context_aware.azure_defender_enabled_rules import NonCarAzureAppServicesDefenderEnabled


class TestNonCarAzureAppServicesDefenderEnabled(unittest.TestCase):
    def setUp(self):
        self.rule = NonCarAzureAppServicesDefenderEnabled()

    @parameterized.expand(
        [
            ['AppServices-FreeTier-ShouldAlert', SubscriptionPricingResourceType.APP_SERVICES, SubscriptionPricingTier.FREE, True],
            ['AppServices-Standard-Ok', SubscriptionPricingResourceType.APP_SERVICES, SubscriptionPricingTier.STANDARD, False],
