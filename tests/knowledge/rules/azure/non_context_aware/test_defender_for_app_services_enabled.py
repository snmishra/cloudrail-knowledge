...
from cloudrail.knowledge.rules.azure.non_context_aware.defender_enabled_rules import AppServicesDefenderEnabled


class TestAppServicesDefenderEnabled(unittest.TestCase):
    def setUp(self):
        self.rule = AppServicesDefenderEnabled()
