    ...
    @parameterized.expand(
        [
            ['No monitoring settings',
             None, True],
            ['No logs',
             AzureMonitorDiagnosticSetting('settings_name', 'event_hub_namespace_id', None, None), True],
            ['Logs enabled, but no retention policy',
             AzureMonitorDiagnosticSetting('settings_name', 'event_hub_namespace_id', AzureMonitorDiagnosticLogsSettings(True, None), None), True],
            ['Logs disabled, no retention policy',
             AzureMonitorDiagnosticSetting('settings_name', 'event_hub_namespace_id', AzureMonitorDiagnosticLogsSettings(False, None), None), True],
