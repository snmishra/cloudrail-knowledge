...
#       - 1 IGW
#       - 5 route tables
#       - 40 EC2 instances in public and private subnets
#       - 57 lambda functions with ENI in each private subnet (4x ENI)
#       - 99 interface service endpoints with ENI in each private subnet (4x ENI)
#       - 12 RDS instances
#
#   - 1 VPC with:
#       - 2 public subnets
...
#       - 1 IGW
#       - 5 route tables
#       - 50 lambda functions with ENI in each private subnet (4x ENI)
#       - 12 RDS instances
#
#   - 1 VPC with:
#       - 2 public subnets
...
#       - 1 IGW
#       - 5 route tables
#       - 26 lambda functions with ENI in each private subnet (4x ENI)
#       - 6 RDS instances
#
#   - 10 IAM groups
#   - 50 IAM users (attached to groups)
#   - 20 IAM roles for EC2 instances
#   - 136 IAM roles for Lambda functions
#
# with a total of 1000 ENIs
#
################################################################################
